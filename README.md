...
![Accuracy Comparison](08_results/figures/accuracy_comparison.png)

### 推理速度对比

![Speed Comparison](08_results/figures/speed_comparison.png)

### 鲁棒性曲线

![Robustness Curve](08_results/figures/robustness_curve.png)

### 过拟合差值对比

![Overfit Gap](08_results/figures/overfit_gap_comparison.png)

### ANN Loss 曲线

![ANN Loss Curve](08_results/figures/ann_loss_curve.png)

> [!TIP]
> 如果图片无法在 GitHub 页面显示，请检查对应图片是否已经提交到仓库，并确认 `.gitignore` 没有忽略 `08_results/figures/` 目录。
...
欢迎大家提出建议，也欢迎围绕机器学习工程实践、模型对比实验和 GitHub 项目展示进行交流讨论。
